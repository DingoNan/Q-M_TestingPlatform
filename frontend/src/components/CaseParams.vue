<template>
  ...
  <div>
     <vxe-table
          ...
          show-overflow
          :data="tableData">
          <vxe-column field="name" title="参数名称" min-width="300">
            <template #default="{ row, rowIndex }">
               <FuncAndParams :is_case_data="true" :bind_case_data='bind_case_data' :value='row.name' :row='row'  :index='rowIndex' :steps='steps' :bind_env_params='bind_env_params'  :bind_global_params='bind_global_params' :is_case_params="true" :case_table_data='tableData' :func_list='func_list' @update:value="handleUpdateName(row, $event)"></FuncAndParams>
            </template>
          </vxe-column>
          <vxe-column field="value" title="参数值" min-width="300" >
            <template #default="{ row, rowIndex }">
               <FuncAndParams  :is_case_data="true" :bind_case_data='bind_case_data' :value='row.value' :row='row'  :index='rowIndex' :steps='steps' :func_list='func_list' :is_case_params="true" :bind_env_params='bind_env_params'  :bind_global_params='bind_global_params' :case_table_data='tableData' @update:value="handleUpdateValue(row, $event)"></FuncAndParams>
            </template>
          </vxe-column>
