<template>
			  ...
			  <el-main style="padding-top: 0px; padding-left: 10px; padding-right: 0px;">
				  <div class="case_tree case">
					  ...
					  <el-card style='margin-bottom: 10px;'>
						 ...
						 <div style="padding-top: 10px; padding-right: 33px; padding-bottom: 10px; background-color: white; display: flex; justify-content: flex-end" class='btn_right'>
	...
	<div class="case" v-if='case_model==="list"'>
	   ...
	   <el-card style='margin-bottom: 10px;'>
	   		<div style="background-color: white; padding-bottom: 10px;">
	   				   <div style="padding-top: 10px; padding-right: 23px; padding-bottom: 10px; background-color: white; display: flex; justify-content: flex-end" class='btn_right'>
	   				   	<el-tooltip content="切换模式">
	   				   		<el-button  @click="changeMode" :icon="Switch"></el-button>
	   				   	</el-tooltip>
	   				   	<el-button v-if='permission.has_add_permission' @click="addCase" type="primary" >新增</el-button>
